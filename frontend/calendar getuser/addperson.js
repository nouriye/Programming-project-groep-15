...
//pagina die blacklist ophaalt V => knop => pagina die gebruikers ophaalt V=> gebruiker selecteren v => id van gebruiker ophalen v => 
    //id van gebruiker invullen in inputveld V => inputveld maken voor reden=>
        ...
        //let info= ['email','id','stunaam','reden'];
            ...
            await getData(`http://localhost:3000/userss/${searchTerm}`,'GET').then(data=>{
         ...
         //new item
                ...
                listitem4.textContent= `${item2.id}`
                listitem4.addEventListener('click',()=>clickitem(item2._id,item2.Stunaam,item2.email,div2))
                counter++    
    
                let listitem5= document.getElementById(counter.toString());
                listitem5.textContent= `${item2.email}`
                ...
                listitem6.textContent= `${item2.Stunaam}`
                ...
                listitem7.textContent= `${item3.id}`
                ...
                listitem8.textContent= `${item3.email}`
                ...
                listitem9.textContent= `${item3.Stunaam}`
        ...
        window.location.href= "../toestel uitlenen(lijst)/Geleen-toestel.html"
        }
